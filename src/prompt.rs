...
pub fn help_text() -> String {
    format!(
        ...
        muted("press"), emphasize("HH:MM:SS + enter"), muted("to jump to that time"),
        muted("press"), emphasize("MM:SS + enter"), muted("to jump to that time"),
        muted("press"), emphasize("SS + enter"), muted("to jump to that time"),
        muted("press"), emphasize("+MM:SS + enter"), muted("to jump forward from the current time"),
        muted("press"), emphasize("-MM:SS + enter"), muted("to jump backward from the current time"),
        muted("press"), emphasize("reopen + enter"), muted("to open the stream again in QuickTime Player"),
        muted("press"), emphasize("status + enter"), muted("to show the current stream and playback time"),
        muted("press"), emphasize("h + enter"), muted("to show this list"),
        muted("press"), emphasize("q + enter"), muted("to stop quickbridge and close QuickTime Player")
    )
}
